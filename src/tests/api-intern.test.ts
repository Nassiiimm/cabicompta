...
const mockAdmin  = { id: "admin-1",  role: "ADMIN" as const,  email: "admin@test.com",  name: "Admin",  authId: "a", phone: null, avatarUrl: null, presenceNoticeAckedAt: null, aiConsentAckedAt: null };
const mockIntern = { id: "intern-1", role: "INTERN" as const, email: "intern@test.com", name: "Intern", authId: "b", phone: null, avatarUrl: null, presenceNoticeAckedAt: null, aiConsentAckedAt: null };
